...
public class NavigationModel implements org.smartregister.chw.core.model.NavigationModel.Flavor {
    ...
    public List<NavigationOption> getNavigationItems() {
        if (navigationOptions.size() == 0) {
            ...
            NavigationOption op13 = new NavigationOption(R.mipmap.sidemenu_hiv,R.mipmap.sidemenu_hiv_active,R.string.PMTCT,CoreConstants.DrawerMenu.PMTCT,0);
            if (BuildConfig.BUILD_FOR_BORESHA_AFYA_SOUTH) {
                navigationOptions.addAll(Arrays.asList(op1,op2,op8,op9,op10,op3,op4,op13,op12,op5,op6,op7,op11));
            }else{
