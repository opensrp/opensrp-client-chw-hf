...
public class VmmcNotifiableAdverseActivity extends BaseVmmcVisitActivity {
    ...
    public void initializeActions(LinkedHashMap<String, BaseVmmcVisitAction> map) {
        ...
        if (map.containsKey(getString(R.string.vmmc_notifiable_adverse))) {
            BaseVmmcVisitAction visitTypeAction = map.get(getString(R.string.vmmc_notifiable_adverse));
            actionList.put(getString(R.string.vmmc_notifiable_adverse), visitTypeAction);
        }
