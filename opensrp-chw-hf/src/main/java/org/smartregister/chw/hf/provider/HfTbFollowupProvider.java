...
public class HfTbFollowupProvider extends HfTbRegisterProvider {

    public HfTbFollowupProvider(Context context, Set visibleColumns, View.OnClickListener onClickListener, View.OnClickListener paginationClickListener) {
    ...
    private void showLatestHivReferralDay(CommonPersonObjectClient client, HfRegisterViewHolder viewHolder) {
