    ...
    public String getPreProcessed() {
        ...
        if (fetalWellBeingForm != null) {
            try {
                ...
                if (LDDao.getPresentingPart(baseEntityId) != null && (LDDao.getPresentingPart(baseEntityId).equalsIgnoreCase("breech") || LDDao.getPresentingPart(baseEntityId).equalsIgnoreCase("shoulder"))) {
                    if (mouldingOptions != null) mouldingOptions.put("hidden", true);
                } else if (LDDao.getMoulding(baseEntityId) != null && LDDao.getMoulding(baseEntityId).equalsIgnoreCase("yes")) {
