...
public class LDSummaryDetailsInteractor extends CoreBaseAncMedicalHistoryInteractor {
    public static List<Visit> getVisits(String memberID, String... eventTypes) {
        ...
        if (eventTypes != null && eventTypes.length > 0) {
            ...
            getVisitsOnly(memberID, Constants.Events.LD_GENERAL_EXAMINATION);
        }
    ...
    public void getMemberHistory(final String memberID, final Context context, final BaseAncMedicalHistoryContract.InteractorCallBack callBack) {
        final Runnable runnable = () -> {
            ...
            String[] eventTypes = new String[3];
            eventTypes[0] = Constants.Events.LD_GENERAL_EXAMINATION;
            eventTypes[1] = Constants.Events.LD_ACTIVE_MANAGEMENT_OF_3RD_STAGE_OF_LABOUR;
            eventTypes[2] = Constants.Events.LD_POST_DELIVERY_MOTHER_MANAGEMENT;
