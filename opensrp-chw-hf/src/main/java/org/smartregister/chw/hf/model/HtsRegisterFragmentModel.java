...
public class HtsRegisterFragmentModel extends BaseHivRegisterFragmentModel {

    @NonNull
    @Override
    public String mainSelect(@NonNull String tableName, @NonNull String mainCondition) {
        SmartRegisterQueryBuilder queryBuilder = new SmartRegisterQueryBuilder();
        queryBuilder.selectInitiateMainTable(CoreConstants.TABLE_NAME.HTS_MEMBERS, mainColumns(CoreConstants.TABLE_NAME.HTS_MEMBERS));
        queryBuilder.customJoin("INNER JOIN " + CoreConstants.TABLE_NAME.FAMILY_MEMBER + " ON  " + CoreConstants.TABLE_NAME.HTS_MEMBERS + "." + DBConstants.KEY.BASE_ENTITY_ID + " = " + CoreConstants.TABLE_NAME.FAMILY_MEMBER + "." + DBConstants.KEY.BASE_ENTITY_ID + " COLLATE NOCASE ");
        ...
        queryBuilder.customJoin("LEFT JOIN (select base_entity_id , max(visit_date) visit_date from visits GROUP by base_entity_id) VISIT_SUMMARY ON VISIT_SUMMARY.base_entity_id = " + CoreConstants.TABLE_NAME.HTS_MEMBERS + "." + DBConstants.KEY.BASE_ENTITY_ID);
    ...
    public String[] mainColumns(String tableName) {
        ...
        columnList.add(CoreConstants.TABLE_NAME.HTS_MEMBERS + "." + Key.CTC_NUMBER);
        columnList.add(CoreConstants.TABLE_NAME.HTS_MEMBERS + "." + Key.CBHS_NUMBER);
        columnList.add(CoreConstants.TABLE_NAME.HTS_MEMBERS + "." + Key.CLIENT_HIV_STATUS_DURING_REGISTRATION);
        columnList.add(CoreConstants.TABLE_NAME.HTS_MEMBERS + "." + Key.CLIENT_HIV_STATUS_AFTER_TESTING);
