...
public class HivFollowupFragmentModel extends BaseHivRegisterFragmentModel {
    ...
    public String[] mainColumns(String tableName) {
        ...
        columnList.add("T3." + Key.HIV_COMMUNITY_FOLLOWUP_VISIT_DATE + " AS " + Key.HIV_COMMUNITY_FOLLOWUP_VISIT_DATE);
