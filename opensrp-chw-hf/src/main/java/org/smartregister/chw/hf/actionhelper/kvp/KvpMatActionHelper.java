...
public class KvpMatActionHelper implements BaseKvpVisitAction.KvpVisitActionHelper {

    private String mat_provided;
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            JSONObject jsonObject = new JSONObject(jsonPayload);
            mat_provided = CoreJsonFormUtils.getValue(jsonObject, "mat_provided");
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
    ...
    public BaseKvpVisitAction.Status evaluateStatusOnPayload() {
        if (StringUtils.isBlank(mat_provided))
