...
public class HeiHivResultsFragmentModel extends BaseHvlResultsFragmentModel {
    ...
    public String mainSelect(@NonNull String tableName, @NonNull String mainCondition) {
        ...
        queryBuilder.customJoin("LEFT JOIN " + Constants.TableName.HEI_HIV_RESULTS + " ON " + Constants.TableName.HEI_HIV_RESULTS + "." + Constants.DBConstants.HEI_FOLLOWUP_FORM_SUBMISSION_ID + " = " + tableName + "." + DBConstants.KEY.BASE_ENTITY_ID);
    ...
    protected String[] mainColumns(String tableName) {
        ...
        columnList.add(Constants.TableName.HEI_FOLLOWUP + "." + Constants.DBConstants.HEI_HIV_SAMPLE_ID);
        columnList.add(Constants.TableName.HEI_HIV_RESULTS + "." + Constants.DBConstants.HEI_HIV_TEST_RESULT);
        columnList.add(Constants.TableName.HEI_FOLLOWUP + "." + Constants.DBConstants.HEI_HIV_SAMPLE_COLLECTION_DATE);
        columnList.add(Constants.TableName.HEI_HIV_RESULTS + "." + Constants.DBConstants.HEI_HIV_RESULT_DATE);
        columnList.add(Constants.TableName.HEI_HIV_RESULTS + "." + Constants.DBConstants.HEI_FOLLOWUP_FORM_SUBMISSION_ID);
        columnList.add(Constants.TableName.HEI_FOLLOWUP + "." + Constants.DBConstants.HEI_HIV_TYPE_OF_TEST);
