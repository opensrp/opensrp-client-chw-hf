...
public class PncReportsViewActivity extends HfReportsViewActivity {
    public static void startMe(Activity activity, String reportPath, String reportDate) {
        ...
        intent.putExtra(ARG_REPORT_TITLE, R.string.pnc_reports);
        intent.putExtra(ARG_REPORT_TYPE, Constants.ReportConstants.ReportTypes.PNC_REPORT);
