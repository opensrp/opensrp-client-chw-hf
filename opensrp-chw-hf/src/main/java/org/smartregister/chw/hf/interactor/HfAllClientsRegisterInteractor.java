...
public class HfAllClientsRegisterInteractor extends BaseOpdRegisterActivityInteractor {
    ...
    public AllSharedPreferences getAllSharedPreferences() {
        return HealthFacilityApplication.getInstance().getContext().allSharedPreferences();
    }
}
