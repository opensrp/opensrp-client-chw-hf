...
public class IssuedReferralsModel extends BaseReferralModel {
    ...
    public String mainSelect(String tableName, String entityTable, String mainCondition) {
        ...
        queryBuilder.customJoin(String.format("INNER JOIN %s  ON  %s.%s = %s.%s AND ec_referral.referral_type = 'facility_to_facility_referral' COLLATE NOCASE ", CoreConstants.TABLE_NAME.REFERRAL,
