...
public class HfAllClientRegisterPresenter extends CoreAllClientsRegisterPresenter {

    public HfAllClientRegisterPresenter(OpdRegisterActivityContract.View view, OpdRegisterActivityContract.Model model) {
        super(view, model);
    }
